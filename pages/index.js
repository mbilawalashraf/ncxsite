                    ...
                    <div class="mx-6 py-10 text-center md:text-left">
                        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                            <div class="">
                                ...
                                <p class="mb-4">
                                <a href="#!" class="">Buy Crypto</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">Crypto Exchange</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">NCX Card</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">NCX Prime</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">Earn</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">Referral Program</a>
                                </p>
                            </div>
                            <div class="">
                                {/* <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                            ...
                            <div class="">
                                ...
                                <p class="mb-4">
                                <a href="#!" class="">Fees and Limits</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">KYX and AML Policy</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">Prohibited Jurisdictions</a>
                                </p>
                                <p class="mb-4">
                                <a href="#!" class="">Cookies Policy</a>
                                </p>
                            </div>
                            <div class="">
