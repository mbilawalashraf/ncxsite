                ...
                <div className="max-w-screen-xl mx-auto px-4">
                        ...
                        <div className="grid grid-cols-5 mt-14">
                            ...
                            <div className={styles.tabs}>
                                    ...
                                    <label for="tabone">Press Room</label>
                                    <div className={styles.tab}>
                                        <div className="container">
                                            ...
                                            <div className="">
                                            {/* Pagination Section */}
                                            <div class="bg-white px-4 py-3 flex items-center justify-between border-gray-200 sm:px-6 float-right">
                                    ...
                                    <label for="tabfour">Market Analysis</label>
                                    <div className={styles.tab}>
                                    <div className="container">
                                            <div className="flex mx-auto mt-4 h-80">
                                                <div className="flex relative w-6/12">
                                    ...
                                    <label for="tabfive">Insights</label>
                                    <div className={styles.tab}>
                                    <div className="container">
                                            <div className="flex mx-auto mt-4 h-80">
                                                <div className="flex relative w-6/12">
                                    ...
                                    <label for="tabsix">Explainer</label>
                                    <div className={styles.tab}>
                                    <div className="container">
                                            <div className="flex mx-auto mt-4 h-80">
                                                <div className="flex relative w-6/12">
